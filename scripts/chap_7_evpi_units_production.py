...
import numpy as np
from src.distribution import DistributionFromData, Gaussian
...
def main():
    ...
    print(
        f"Expected value of perfect information (calculated from Gauss): {evpi_gauss:.1f}"
    )
    ...
    print(
        f"Expected value of perfect information (calculated from data distribution): {evpi_data_dist:.1f}"
    )
